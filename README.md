...
Standalone version of the [Bedrock Autoloader](https://github.com/roots/bedrock/blob/1.13.3/web/app/mu-plugins/bedrock-autoloader.php) for must-use plugins.
